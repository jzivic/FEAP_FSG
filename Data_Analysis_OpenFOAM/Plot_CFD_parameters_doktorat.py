...
case = "//home/josip/foamOpen/Doktorat/simulacija8_t1"



# simulations_times = {53:[1.25, 1.3, 1.5]}
# simulations_times = {8:[2], 53:[2]}
simulations_times = {8:[2]}
    ...
    def Plot_radius_NOVI(self):
        ...
        for sim in simulations_times.keys():
            for moment in simulations_times[sim]:
                ...
                # plt.plot(self.data_DF["r"][n_count], self.data_DF["z"][n_count], label="$r_{max}=$"+str(legenda[n_count]*2)+"mm")
                n_count +=1
        plt.ylim(50,200)
        plt.xlim(9,16)
